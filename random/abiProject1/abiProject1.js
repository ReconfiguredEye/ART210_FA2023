...
function preload(){
 ...
 bootImg = loadImage('assets/boot.png');
 hookMouse = loadImage('assets/hookMouse.png');
}
...
function drawHooked(hooked){
  ...
  if (hooked.type === 'fishImg'){
    image(fishImg, hooked.x, hooked.y, fishImg.height/3, fishImg.width/3)
  } else if (hooked.type === 'bootImg'){
    image(bootImg, hooked.x, hooked.y, bootImg.height/3, bootImg.width/3)
  }
  pop();
}
